...
extern map<string, string> str_labels_map;
...
public:
	String_Ast(string str, Data_Type constant_data_type, int line);
	~String_Ast();
...
class Return_Ast: public Ast {
	...
	string fn_name;
public:
	Return_Ast(string fn_name, Ast* ret, int line);
	~Return_Ast();
...
class Function_Call_Ast: public Ast {
	...
	Symbol_Table formal_table;
	Procedure* proc;
public:
	Function_Call_Ast(Procedure* proc, string name, Data_Type ret_type, vector<Ast*> *params, Symbol_Table& sym_tab, int line);
	~Function_Call_Ast();
